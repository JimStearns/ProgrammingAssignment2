...
#
# Not implemented (and not required for program assignment): a parameter check that throws error 
# if the first parameter 'x' is not a CacheMatrix object created by makeCacheMatrix().
